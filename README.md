...
- **E**: インベントリ画面の開閉（2×2クラフト）。アイテムは**アイコン表示**、スロットは**タップ/クリック移動**または**ドラッグ移動**。ツールは耐久バー表示
...
- 画面**右側をドラッグ**: 視点
- **⛏ ボタン**: 破壊、**⬛ ボタン**: 設置（作業台/かまどに照準を合わせて押すと開く）、**⤒ ボタン**: ジャンプ
- **🎒 ボタン（右上）**: インベントリ開閉（2×2クラフト）。スロットを**タップ**でアイテム移動・クラフト
